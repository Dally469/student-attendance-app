            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDetailRow('Charges per transfer', '\$${(fee.amountOutstanding ?? 0).abs().toStringAsFixed(2)}', blackColor),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildDetailRow('Amount Due', '\$${fee.amountDue?.toStringAsFixed(2) ?? '0.00'}', blackColor),
                                _buildDetailRow('Amount Paid', '\$${fee.amountPaid?.toStringAsFixed(2) ?? '0.00'}', blackColor),
                                _buildDetailRow('Charges per transfer', '\$${(fee.amountOutstanding ?? 0).abs().toStringAsFixed(2)}', Colors.red),
                                _buildDetailRow('Due Date', _formatDate(fee.dueDate), blackColor),
                              ],
                            ),
                          ),
